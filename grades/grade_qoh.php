...
<br /> 
         ...
         <table  class="table table-striped table-bordered">     
                    ...
                    -->
                            ...
                            <?php 
                            $query=mysqli_query($mysqli, "select * from qoh_table")or die(mysqli_error());
                            $numberOfRows= mysqli_num_rows($query);

                            echo "<h4>You've successfully attempted " . " " . $numberOfRows . " ". "Questions in QOH section</h4><br \>";
                    ...
                    <!--
                          ...
                          <?php
                            $result = mysqli_query($mysqli, "SELECT count(ID) FROM qoh_table") or die(mysqli_error());
                        ...
                        <tr>
                                ...
                                ?>
                            <?php
                            $result = mysqli_query($mysqli, "SELECT count(Question) FROM qoh_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                           ...
                           <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Strongly_Agree) FROM qoh_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Agree) FROM qoh_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Disagree) FROM qoh_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Strongly_Disagree) FROM qoh_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                 ...
                 -->
                        ...
                        <a href="../output7/qmsResults.php" target="_blank" class="previous round">&#8249;Check the Respondent Rating </a><a href="../qms8/qms_one.php" target="_blank" class="next round pull-right">Proceed to QWS Sections &#8250; </a>
