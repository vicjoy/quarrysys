...
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">     
                    ...
                    -->
							...
							<?php 
							$query=mysqli_query($mysqli, "select * from qms_table")or die(mysqli_error());
                            $numberOfRows= mysqli_num_rows($query);

                            echo "<h4>You've successfully attempted " . " " . $numberOfRows . " ". "Questions in QMS section</h4><br \>";
					...
					<!--
						  ...
						  <?php
                            $result = mysqli_query($mysqli, "SELECT count(ID) FROM qms_table") or die(mysqli_error());
                        ...
                        <tr>
                                ...
                                ?>
                            <?php
                            $result = mysqli_query($mysqli, "SELECT count(Question) FROM qms_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
						   ...
						   <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Strongly_Agree) FROM qms_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Agree) FROM qms_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Disagree) FROM qms_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Strongly_Disagree) FROM qms_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                 ...
                 -->
                        ...
                        <a href="../output/qmsResults.php" target="_blank" class="previous round">&#8249;Check the Respondent Rating </a><a href="../qms2/qms_one.php" target="_blank" class="next round pull-right">Proceed to QES Sections &#8250; </a>
