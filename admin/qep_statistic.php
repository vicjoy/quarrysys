...
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">     
                    ...
                    -->
                            ...
                            echo "<h4>There are " . " " . $numberOfRows . " ". "Questions in Quarry Emergency Plans (QEP) section</h4><br \>";
                        ...
                        <tr>
						   ...
						   <?php
                            ...
                            while ($rows = mysqli_fetch_array($result)) {
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Disagree) FROM qep_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Strongly_Disagree) FROM qep_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
