...
require '../configure.php';
    ...
    if ($db_found) {
        ...
        $stmt = $db_found->prepare("SELECT ID, Question, OptionA, OptionB, OptionC, OptionD FROM qit_table WHERE ID = 5");
...
?>
            ...
            <FORM NAME ="form1" METHOD ="GET" ACTION ="../model4/process_five.php">
