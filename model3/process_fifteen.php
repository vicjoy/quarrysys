...
function insert_vote($db, $sql, $id) {
	...
	//header('survey2.php'); 
	echo "<script>alert('Completed!!! Thanks for your response! All your answers are successfully saved. Click OK to check the Graded Audit Chat & RESPONDENTS Ratings'); window.location='../grades/grade_qbp.php'</script>";
}