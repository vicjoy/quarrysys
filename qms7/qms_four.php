...
require '../configure.php';
    ...
    if ($db_found) {
        ...
        $stmt = $db_found->prepare("SELECT ID, Question, OptionA, OptionB, OptionC, OptionD FROM qoh_table WHERE ID = 4");
...
?>
            ...
            <FORM NAME ="form1" METHOD ="GET" ACTION ="../model7/process_four.php">
