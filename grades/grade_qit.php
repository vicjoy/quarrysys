...
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">     
                    ...
                    -->
							...
							<?php 
							$query=mysqli_query($mysqli, "select * from qit_table")or die(mysqli_error());
					...
					<!--
						  ...
						  <?php
                            $result = mysqli_query($mysqli, "SELECT count(ID) FROM qit_table") or die(mysqli_error());
                        ...
                        <tr>
                                ...
                                ?>
                            <?php
                            $result = mysqli_query($mysqli, "SELECT count(Question) FROM qit_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
						   ...
						   <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Strongly_Agree) FROM qit_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Agree) FROM qit_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Disagree) FROM qit_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                ...
                                ?>
                                <?php
                            $result = mysqli_query($mysqli, "SELECT sum(Strongly_Disagree) FROM qit_table") or die(mysqli_error());
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                 ...
                 -->
                        ...
                        <a href="../output4/qmsResults.php" target="_blank" class="previous round">&#8249;Check the Respondent Rating </a><a href="../qms5/qms_one.php" target="_blank" class="next round pull-right">Proceed to QTS Sections &#8250; </a>
