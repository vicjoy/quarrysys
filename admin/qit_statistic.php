...
<br /> 
	     ...
	     <table  class="table table-striped table-bordered">     
                    ...
                    -->
                            ...
                            echo "<h4>There are " . " " . $numberOfRows . " ". "Questions in Quarry Isolation and Tagging (QIT) section</h4><br \>";
                  ...
                  -->
                                    <div class="pull-center">
                                        <div class="span"><div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;<center>GRADED AUDIT CHAT and COMPLIANCE to QuarrySYS:</center>&nbsp;<br><hr><?php 
