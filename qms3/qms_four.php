...
require '../configure.php';
    ...
    if ($db_found) {
        ...
        $stmt = $db_found->prepare("SELECT ID, Question, OptionA, OptionB, OptionC, OptionD FROM qbp_table WHERE ID = 4");
...
?>
            ...
            <html>
            <body>
            <?php include('../bar/progress_15.php');?>
            <FORM NAME ="form1" METHOD ="GET" ACTION ="../model3/process_four.php">
