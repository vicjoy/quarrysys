...
require '../configure.php';
	...
	if ($db_found) {
		...
		$stmt = $db_found->prepare("SELECT ID, Question, OptionA, OptionB, OptionC, OptionD FROM qts_table WHERE ID = 1");
...
?>
			...
			<FORM NAME ="form1" METHOD ="GET" ACTION ="../model5/process_one.php">
