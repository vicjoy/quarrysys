...
require '../configure.php';
	...
	if ($db_found) {
		...
		$stmt = $db_found->prepare("SELECT ID, Question, OptionA, OptionB, OptionC, OptionD FROM qep_table WHERE ID = 1");
...
?>
			...
			<FORM NAME ="form1" METHOD ="GET" ACTION ="../model6/process_one.php">
