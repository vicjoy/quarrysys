	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="nav navbar-nav">
				...
				<li><a href="../admin/table_section.php" target="">Quarry Tables</a></li>
	        	<li><a href="../reset-password.php" ><span class="next glyphicon glyphicon-erase"></span>Reset Password</a></li>
	            <li><a href="../logout.php" ><span class="next glyphicon glyphicon-log-out">Logout</span></a></li>
